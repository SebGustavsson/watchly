...
rolex_datejust = Watch.new(address: "Drottningholm Stockholm", brand: 'Rolex', model: "Datejust", year: 2013, user_id: john.id, description: "Rolex presents four white Rolesor versions (combining Oystersteel and white gold) of the Oyster Perpetual Datejust 31. The first watch, featuring a bezel set with 46 brilliant-cut diamonds.")
...
rolex_submariner = Watch.new(address: "Ringvägen 20 Stockholm", brand: 'Rolex', model: "Submariner", year: 2015, user_id: john.id, description: "The Oyster Perpetual Submariner in Oystersteel with a Cerachrom bezel insert in black ceramic and a black dial with large luminescent hour markers.")
...
patek_philippe_nautilus = Watch.new(address: "Vallagränd 10 Stockholm", brand: 'Patek Philippe', model: "Nautilus", year: 2017, user_id: john.id, description: "On its 5711/1A model, Patek Philippe unveils a dial in a brand-new olive-green shade that is new to the Nautilus collection and which should delight lovers of this cult watch.")
...
breitling_navitimer = Watch.new(address: "Rämensvägen 15 Stockholm", brand: 'Breitling', model: "Navitimer", year: 2014, user_id: john.id, description: "FOR MORE THAN 65 YEARS, THE BREITLING NAVITIMER HAS BEEN ONE OF THE WORLD’S MOST BELOVED MECHANICAL CHRONOGRAPHS. THE NAVITIMER FAMILY INTRODUCES A WATCHMAKING LEGEND TO A WHOLE NEW GENERATION.")
...
seiko_sarb033 = Watch.new(address: "Drottninggatan 19 Stockholm", brand: 'Seiko', model: "SARB-033", year: 2021, user_id: john.id, description: "Seiko is one of the few fully integrated watch manufactures. We design and develop our own movements using leading-edge technology.")
...
iwc_portugieser = Watch.new(address: "Kungsgatan 22 Stockholm", brand: 'IWC', model: "Portugieser", year: 2009, user_id: john.id, description: "The Portugieser is one of the oldest and best-known watches from IWC. No other IWC watch family incorporates so many of the technical tours de force of haute")
...
breitling_superocean = Watch.new(address: "Nygatan Karlstad", brand: 'Breitling', model: "Superocean", year: 2012, user_id: john.id, description: "The SuperOcean defines the classic dive watch. It was created by Breitling in 1957 to equip professional and military divers")
...
oris_big_crown = Watch.new(address: "Götgatan 22 Stockholm", brand: 'Oris', model: "Big Crown", year: 2021, user_id: john.id, description: "Oris began making pilot’s watches in the 1910s at the dawn of aviation and has pioneered in the field ever since. ")
