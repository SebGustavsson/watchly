...
rolex_datejust = Watch.new(brand: 'Rolex', model: "Datejust", year: 2013, user_id: john.id)
...
rolex_submariner = Watch.new(brand: 'Rolex', model: "Submariner", year: 2015, user_id: john.id)
...
tudor_black_bay = Watch.new(brand: 'Tudor', model: "Black Bay", year: 2015, user_id: john.id)
...
patek_philippe_nautilus = Watch.new(brand: 'Patek Philippe', model: "Nautilus", year: 2017, user_id: john.id)
...
breitling_navitimer = Watch.new(brand: 'Breitling', model: "Navitimer", year: 2014, user_id: john.id)
...
seiko_sarb033 = Watch.new(brand: 'Seiko', model: "SARB-033", year: 2021, user_id: john.id)
...
iwc_portugieser = Watch.new(brand: 'IWC', model: "Portugieser", year: 2009, user_id: john.id)
...
breitling_superocean = Watch.new(brand: 'Breitling', model: "Superocean", year: 2012, user_id: john.id)
...
oris_big_crown = Watch.new(brand: 'Oris', model: "Big Crown", year: 2021, user_id: john.id)
